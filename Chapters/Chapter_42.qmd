...
![Die Edges zwischen den Tris, welche nicht entlang der Achsen verlaufen, können aufgelöst werden, damit Quads entstehen.](Images/Chapter_42/2_Edges_To_Delete.png){#fig-1_1 fig-align="left"}
...
![Eine UV-Sphere, deren unteren Ende lediglich aus Quads besteht und mit einem Subdivision-Surface-Modifier ausgestattet wurde.](Images/Chapter_42/3_Subdivisions.png){#fig-1_2 fig-align="left"}
...
![Die UV-Sphere wird zur Form des Kopfes ausgerichtet. Dabei befindet sich die Siete mit den Tris unten.](Images/Chapter_42/4_Kopf_ausrichten.png){#fig-1_3 fig-align="left"}
...
![Die überlappenden Vertices werden von beiden UV-Spheres entfernt und die beiden UV-Spheres miteinander verbunden.](Images/Chapter_42/5_Kopf_Koerper_verbinden.png){#fig-1_4 fig-align="left"}
...
![Die Hälfte des Meshes wird entfernt, damit es mit einem Mirror-Modifier für die weitere Bearbeitung gespiegelt werden kann.](Images/Chapter_42/6_Kopf_Koerper_Modifiers.png){#fig-1_5 fig-align="left"}
...
![Die Faces, aus denen der Arm extrudiert werden soll, werden ausgewählt.](Images/Chapter_42/7_Arm_Vertices.png){#fig-1_6 fig-align="left"}
...
![Ein Ansatz für den Arm wird extrudiert.](Images/Chapter_42/8_Armansatz.png){#fig-1_7 fig-align="left"}
...
![Die Vertices, des extrudierten Armes werden kreisförmig angeordnet.](Images/Chapter_42/9_arm_rund.png){#fig-1_8 fig-align="left"}
...
![Die Arme werden entsprechend dem Referenzbild schrittweise extrudiert.](Images/Chapter_42/10_arm_extrudiert.png){#fig-1_9 fig-align="left"}
...
![Die Faces, aus denen die Beine extrudiert werden, werden ausgewählt.](Images/Chapter_42/11_Vertices_Beine.png){#fig-1_10 fig-align="left"}
...
![Die Vertices des Beinansatzes werden kreisförmig angeordnet.](Images/Chapter_42/11_1_Bein_kreisformig.png){#fig-1_11 fig-align="left"}
...
![Die Beine werden schrittweise entlang der Referenzvorlage extrudiert.](Images/Chapter_42/13_Beine_extrudiert.png){#fig-1_12 fig-align="left"}
...
![Die Faces, aus denen die Ohren extrudiert werden, werden ausgewählt.](Images/Chapter_42/14_Ohren_Vertices.png){#fig-1_13 fig-align="left"}

![Die Ohren werden schrittweise entlang der Referenzvorlage extrudiert.](Images/Chapter_42/15_Ohren_extrudiert.png){#fig-1_14 fig-align="left"}
...
![Die Faces, aus denen der Schwanz extrudiert wird, werden ausgewählt.](Images/Chapter_42/16_Schwanz_Vertices.png){#fig-1_15 fig-align="left"}
...
![Die UV-Map der erstellten Katze ist aufgrund der Mesh-Bearbeitung durcheinander geraten. ](Images/Chapter_42/17_UVs.png){#fig-1_16 fig-align="left"}
...
![Durch die Seams wird vorgegeben, welche Faces in der UV-Map als gemeinsame Insel dargestellt werden sollen.](Images/Chapter_42/18_Seams.png){#fig-1_17 fig-align="left"}
...
![Icons in der Tool-Bar des Texture-Paint-Modes.](Images/Chapter_42/19_Toolbar_Texture_Paint.png){#fig-1_18 fig-align="left"}
...
![Icons in der Toolbar des Particle-Edit-Modes.](Images/Chapter_42/20_Toolbar_Particles_Editor.png){#fig-1_19 fig-align="left"}
