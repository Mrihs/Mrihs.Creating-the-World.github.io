...
![Image-Texture-Node, der neben dem Principled-BSDF-Shader hinzugefügt wurde.](Images/Chapter_23/Anordnung%20Texture%20Node.png){#fig-1_1 fig-align="left"}
...
![Verbindung zwischen einem Image-Texture-Node und der Base-Color des Principled-BSDF-Shaders.](Images/Chapter_23/Texture_Node_connecte.png){#fig-1_2 fig-align="left"}
...
![Ein Image-Texture-Node, der mit einem Texture-Coordinate- und einem Mapping-Node verbunden ist.](Images/Chapter_23/Texture_Node_Mapping.png){#fig-1_3 fig-align="left"}
...
![ Aktiviertes Node-Wrangler-Add-on.](Images/Chapter_23/.png){#fig-1_4 fig-align="left"}
