...
![Eine Plane mit Mirror-, Shrinkwrap- und Subidivision-Surface-Modifier.](Images/Chapter_41/2_Plane_Modified.png){#fig-1_2 fig-align="left"}
...
![Die Edges werden schrittweise extrudiert.](Images/Chapter_41/3_Mesh_Extrusion.png){#fig-1_3 fig-align="left"}

![Besondere körperliche Merkmale, wie etwa die Augen, werden mit einer Schlaufe von Faces umreandet.](Images/Chapter_41/4_Mesh_Head.png){#fig-1_4 fig-align="left"}
...
![Der Kopf nach dem Retopology-Prozess.](Images/Chapter_41/6_Object_Head.png){#fig-1_5 fig-align="left"}
...
![Ein Mesh, sowie deren Vertcies im Vergleich zwischen dem gesculpteten original, einer Bearbeitung mit Quadriflow-Remesh und einer Bearbeitung mit dem Remesh-Modifier.](Images/Chapter_41/7_Vergleich_Remesh.png){#fig-1_6 fig-align="left"}
