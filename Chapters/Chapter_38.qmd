...
:::: downloadbox-body
::: button
[<i class="bi bi-file-earmark-arrow-down-fill"></i> Glas Particles](../assets/Blender_Files/09_Glas_Particles.zip){.btn .btn-light download="Glas Particles"}
:::
::::
::::::
...
![Die Vertices unterhalb der Wasseroberfläche werden ausgewählt und vergrössert, damit sie sich etwas innerhalb des Glases befinden.](Images/Chapter_38/38_8_5_Water_Select_Space.png){#fig-1_5 fig-align="left"}
